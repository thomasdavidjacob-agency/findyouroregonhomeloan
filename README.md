# Find Your Oregon Home Loan — Deployment Checklist
...
3. **Verify your sending domain in Resend**
   Log in to resend.com and verify `findyouroregonhomeloan.com` so `leads@findyouroregonhomeloan.com` is authorized to send.
...
`🏠 New Lead: [Name] — [Loan Type] — findyouroregonhomeloan.com`
